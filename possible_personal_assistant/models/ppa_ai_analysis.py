...
class PpaAiAnalysis(models.Model):
    ...
    summary = fields.Text()
    category = fields.Selection([("customer", "Customer"), ("supplier", "Supplier"), ("internal", "Internal"), ("administrative", "Administrative"), ("technical", "Technical"), ("sales", "Sales"), ("support", "Support"), ("other", "Other"), ("customer_request", "Customer Request"), ("finance", "Finance"), ("project", "Project"), ("notification", "Notification"), ("spam", "Spam")])
    ...
    suggested_flow = fields.Char()
    suggested_project = fields.Char()
    suggested_owner = fields.Char()
    reasoning_summary = fields.Char()
